...
#gst-launch-1.0 tcamsrc num-buffers=30 name=src ! tee name=t t. ! videoconvert ! jpegenc ! multifilesink location=bilder/frame_%04d.jpg t. ! videoconvert ! x264enc tune=4 ! mp4mux ! filesink location=bilder/test.mp4

gst-launch-1.0 tcamsrc num-buffers=10 ! video/x-bayer,format=bggr,width=1024,height=768,framerate=30/1 ! capssetter join=false caps="video/x-bayer,format=gbrg" ! bayer2rgb ! tee name=t t. ! queue ! videoscale ! video/x-raw,framerate=30/1 ! videoconvert ! x264enc rc-lookahead=5 tune=4 ! mp4mux ! filesink location=test.mp4 t. ! queue ! videorate ! video/x-raw,framerate=1/1 ! videoconvert ! jpegenc ! multifilesink location=frame_%04d.jpg
