...
#gst-launch-1.0 tcamsrc num-buffers=10 ! tee name=t t. ! videoconvert ! jpegenc ! multifilesink location=bilder/frame_%04d.jpg t. ! videoconvert ! x264enc ! mp4mux ! filesink location=bilder/faen.mp4
